	...
	<div class="row">
		<div class="col-md-12">
			...
			<form action={{route('student.register.store')}} method="post">
				...
				<p class="theme-header header-sm"> Personal Information </p>
				<div class="row pt-5">
					<div class="col-md-4">
						<label class="form-label">First Name</label>
						<input type="text" class="form-control theme-input-field" name="first_name" value="{{old('first_name')}}" required>
					</div>
					<div class="col-md-4">
				...
				<p class="theme-header header-sm"> Account Register </p>
				<div class="row">
					<div class="col-md-12">
						<div class="row pt-2">
							<div class="col-md-8">
